...
//val v6: = FALSE //все буквы должны быть строчные или стринг, можно и так val v6: String = "FALSE"
val v7: Char = 'c'
val v8: Int = 500
...
val v19: Float = 5.75f
//val v20:  = `1.414` // убрать кавычки, тогда будет дабл
...
//val v30:  = FALSE // см v6, либо добавить двойные кавычки и будет стринг, либо маленькими написать и будет булево
val v31: Double = 0.007
//val v32:  = “🤯” // будет стринг, если поменять на кавычки двойные ""
...
//val v44:  = TRUE //надо писать маленькими буквами, как в v6
...
val airWeight: Float = 12.4839f

//Хранить словарь «название стартапа → сумму потерь инвесторов».
val startupLoses: Map<String, Double> = mapOf("БольшиеБукинги" to 4442.2323, "МалыеБукинги" to 3333.34436)
